...
=== HTTP Request
include::{snippets}/member-getMemberInfo/http-request.adoc[]
request header
include::{snippets}/member-getMemberInfo/request-headers.adoc[]

=== HTTP Response
include::{snippets}/member-getMemberInfo/http-response.adoc[]
include::{snippets}/member-getMemberInfo/response-fields.adoc[]